# ABCL — loan application calls — Context Graph Report
...
- **agent_request_otp** (370x): otp, number, get, terms, mobile, verify
- **customer_acknowledge** (301x): बोलने, पढ़ते, loan, application, check, देर
- **agent_wait** (256x): मदद, आगे, समझ, दिक्कत, हों, लिंक
...
- **agent_transfer_to_rm** (204x): relationship manager, loan, offer, amount, मदद, कृपया
- **agent_send_sms_link** (182x): sms, लिंक भेज, मदद, application, समझ, apply
- **agent_guide_open_link** (178x): खुल गया, लिंक पर क्लिक, sms, बताएं, कृपया, link
- **agent_guide_apply** (170x): apply now, apply, now, देख, नीचे, बताएं
- **customer_request_wait** (160x): काम, इधर, work, minute, open, एक second
- **agent_present_final_offer** (143x): final offer, loan, offer, amount, final, otp
...
- **agent_answer_query** (124x): बोल, तरफ, आदित्य, बिरला, कैपिटल, capital
- **customer_react_to_final_offer** (119x): loan, दिखा, उसमें, pay, lakh, two
- **agent_request_pan** (113x): पैन, बताएं, जाए, page, number, कृपया
- **agent_ask_employment_type** (113x): salaried, self-employ, loan, offer, page, monthly
- **agent_request_terms_accept** (111x): terms and condition, terms, button, check, conditions, details
- **agent_request_personal_details** (110x): gender, date of birth, marital, बताएं, जाए, कृपया
...
- **agent_request_income** (74x): income, fill, monthly, employed, self, बताएं
- **customer_state_employment_type** (67x): self employ, employed, self, salaried, भाई, self employee
...
- **agent_acknowledge** (51x): process, complete, चाहें, मदद, सवाल, तरीके
...
- **agent_request_udyam** (38x): udyam, page, number, mobile, proceed, details
...
- **agent_help_address_error** (30x): name, building, सही, चेक, ध्यान, दिखेंगे
- **agent_end_call** (27x): कॉल, धन्यवाद, चूंकि, समाप्त, प्रतिक्रिया, call
- **agent_reassure_trust** (27x): sms, बताएं, कृपया, तरफ, आगे, मदद
- **agent_offer_skip_udyam** (25x): skip, बताएं, जाए, number, click, application
- **customer_provide_personal_details** (24x): details, professional, number, mobile, enter, name
- **agent_other** (23x): call, relationship, manager, दूँ, हों, कृपया
- **customer_react_to_offer** (23x): lakh, one, thousand, loan, amount, मिल
- **agent_confirm** (21x): apply, आगे, guide, तैयार, steps, मदद
...
- **agent_clarify** (16x): बताएं, कृपया, आगे, खुल, बढ़, submit
...
- **customer_provide_income** (9x): income, monthly, लाख, employed, self, type
