# JustDial — lead-generation support calls — Context Graph Report
...
- **customer_acknowledge** (149x): justdial, दिये, करा, see, telling, speaking
...
- **agent_acknowledge** (51x): दिये, बड़, justdial, customer, call, com
...
- **customer_ask_question** (44x): चेक, लीड, इसको, ऐसा, number, मिल
