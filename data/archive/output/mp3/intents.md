...
| `customer_acknowledge` | Customer acknowledgement / agreement / back-channel | 149 |
...
| `agent_greet` | Agent's opening / identifies the business | 82 |
| `agent_acknowledge` | Agent acknowledgement / back-channel (ok, achha, noted) | 51 |
| `customer_greet` | Customer's opening / confirms who they are | 48 |
